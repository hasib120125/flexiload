                            ...
                            <div class="panel-body">                                
                                <div class="table-responsive">
                                    <table class="table table-bordered datatable " id="table-1"  style="font-size: 12px">
                                        <div class="row">
                                            <form role="form" method="POST" class="form-horizontal" action="<?php echo site_url('admin/tr_search_list'); ?>">
                                                <div class="col-md-5">
                                        ...
                                        <tbody>
                                            ...
                                            $ttl_actual_cost = '';
                                            $balance = 0;
                                            $query = $this->meclicksasia->table('transaction');
                                            ...
                                            foreach ($query as $row):
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $this->meclicksasia->table_info('admin', 'admin_id', $row['admin_id'])->name; ?></td>
