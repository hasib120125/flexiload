...
//                                                        $admin_id = $row['admin_id'];
                                                        $balance = $this->meclicksasia->current_points($row['admin_id']);
...
//                                                        echo $balance;
                                                            ...
                                                            <div class="modal fade" id="modal-<?php echo $row['admin_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <form role="form" method="post" id="addBalance"  class="form-horizontal" action="<?php echo site_url('reseller/send_money/'.$row['admin_id']) ?>">
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group" >                                
                                                                                    ...
                                                                                    <input style="padding-right: 200px;" type="text" class="form-control col-md-2" name="remarks" id="remarks" placeholder="Remarks">
                                                                                    
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-sm btn-danger" data-dismiss="modal">Close</button>
                                                                                <button type="submit" onclick="return confirmbuttontext()" class="btn btn-sm btn-primary example-button">ADD</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <script type="text/javascript">
                                                                    function confirmbuttontext(){
                                                                        ...
                                                                        return confirm("Are You Sure Add Balance?\nAmount = "+bl+"\nRemarks ="+rm);
                    ...
                    <?php $this->session->unset_userdata('sesData'); ?>
                    <div class="row">
                        <div class="col-md-2 pull-left">
