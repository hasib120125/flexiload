                ...
                <div class="main">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">                          
                                <h2><a href="<?php echo site_url('admin/charge_create'); ?>" class="btn btn-default pull-left"  data-animate="1" style="margin-left:5px">Add New Charge</a></h2>
                            </div>
                            <!--                            <div class="col-md-8">
...
//                                        die;
                                        foreach ($query as $row):
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('admin/charge_update/' . $row['charge_id']); ?>" class="btn btn-default btn-sm btn-icon icon-left">
                                                        <i class="entypo-pencil"></i>
                                                        Edit
                                                    </a>
                                                    <a href="<?php echo site_url('admin/charge_delete/' . $row['charge_id']); ?>" onclick="return confirm('Want to delete!')" class="btn btn-default btn-sm btn-icon icon-left">
                                                        <i class="entypo-pencil"></i>
                                                        Delete
                                                    </a>
                                                </td>
